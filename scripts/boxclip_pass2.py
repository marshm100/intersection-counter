...
# STITCH_* / _end_speed / chain_tracks moved to
# backend.services.track_chains (conservation pass port — one source
# of truth); re-imported here so the script's behavior is unchanged.
from backend.services.track_chains import (  # noqa: E402
    STITCH_MOVE_GAP_S, STITCH_MOVE_DIST, STITCH_STAT_SPEED_PXS,
    STITCH_STAT_GAP_S, STITCH_STAT_DIST, _end_speed, chain_tracks,
)
